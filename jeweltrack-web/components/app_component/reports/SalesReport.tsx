...
// {_sum: {…}}
  ...
  const billStatsData = [
    ...
    {title:'Gst Amount',data:billStats?.totalGSTAmount._sum.totalGST ||0,},
    {title:'Gst bill',data:billStats?.totalGstBillCount ||0,},
    {title:'Non gst bill',data:billStats?.totalNonGstBillCount ||0,},
    {title:'Sale Amount',data:billStats?.totalSalesAmount._sum.payableAmount ||0,},
  ]
  ...
  return (
    <div>
        ...
        {/* Stats */}
        <section className="flex gap-x-7 gap-y-4 p-3 my-3   flex-wrap ">
